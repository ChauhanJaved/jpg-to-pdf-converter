    ...
    portfolioItem && (
      ...
      >
        <div className="flex flex-col items-center">
          ...
          />
          <div className="mt-10 grid max-w-[750px] grid-cols-1 gap-5 rounded p-3 text-gray-700 dark:text-gray-300 sm:grid-cols-2 lg:grid-cols-3 lg:border">
          ...
          <div className="mt-5 flex flex-col">
            ...
            <p className="text-base lg:text-lg">
              Enjoy a lifetime of access with just a one-time purchase of our
              JPG to PDF converter. Once you’ve acquired the license, there are
              no recurring fees or subscriptions. This lifetime license provides
              you unlimited use of our powerful conversion tools, making it a
          ...
          <div className="mt-5 flex flex-col">
            ...
            <p className="text-base lg:text-lg">
              Stay up-to-date with all the latest features and enhancements,
              free of charge. Our lifetime license includes complimentary
              upgrades, ensuring you always have access to the most optimized
              and advanced version of our converter. Whether it’s new settings,
              increased speed, or enhanced usability, you’ll receive every
          ...
          <div className="mt-5 flex flex-col">
            ...
            <p className="text-base lg:text-lg">
              Enjoy the flexibility of using our converter on both desktop and
              web platforms with a single license. This dual compatibility
              ensures you have the freedom to work on your preferred device,
              whether you’re at your desk or on the go, maximizing convenience
              and usability without the need for multiple licenses.
            </p>
          </div>
        </div>
      </section>
