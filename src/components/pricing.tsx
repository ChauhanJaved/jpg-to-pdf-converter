      ...
      >
        <div className="flex flex-col items-center">
          ...
          <p className="mt-10 text-gray-700 dark:text-gray-300 lg:text-lg">
            We partner with Bright Market, LLC, dba <strong>FastSpring</strong>,
            located at 801 Garden St., Santa Barbara, CA 93101, USA, for secure
            and efficient payment processing. Once your order is complete,
            FastSpring will immediately send a license key to the email address
            associated with your order. To activate your license, simply enter
            the key in the app. For your privacy, FastSpring does not share any
            sensitive payment information, such as credit card details, with us.
            Your transaction is completely secure.
          </p>
        </div>
      </section>
    )
